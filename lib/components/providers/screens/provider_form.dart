...
class _ProviderFormState extends State<ProviderForm> {
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        IconButton(
                            onPressed: () {},
                            icon: SvgPicture.asset(Assets.images.filter)),
                        const SizedBox(
                          width: 8,
                        ),
                        Container(
                        ...
                        Padding(
                          padding:
                              EdgeInsets.symmetric(horizontal: Adaptive.sp(12)),
                          child: Text(
                            "filterBy".tr(),
                            style: GoogleFonts.nunitoSans(
                        ...
                        InkWell(
                          ...
                          child: Padding(
                            padding: EdgeInsets.only(
                                left: Adaptive.sp(12), right: Adaptive.sp(10)),
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Text(
                        ...
                        if (state.customStartDate != null ||
                          ...
                          InkWell(
                            onTap: () {
                              providersBloc
                                  .add(const ProvidersEvent.resetFilter());
                            },
                            child: Padding(
                              padding: EdgeInsets.only(
                                  left: Adaptive.sp(12),
            ...
            child: Theme(
              data: Theme.of(context).copyWith(
                dividerTheme: const DividerThemeData(
                    color: lightGrayColor, thickness: 0.6),
                cardTheme: CardTheme(
                  elevation: 0,
                  color: Colors.white,
              ...
              child: PaginatedDataTable2(
                ...
                onPageChanged: (index) {
                  ...
                  context.read<ProvidersBloc>().add(
                      ProvidersEvent.changeCurrentTablePageIndex(index: index));
                },
  ...
  Future<void> _displayStatusDialog1() async {
    return showDialog(
        context: context,
                        ...
                        Wrap(
                          ...
                          children: state.providerStatus.map((e) {
                            ...
                            return InkWell(
                              onTap: () {
                                context.read<ProvidersBloc>().add(
                                    ProvidersEvent.setProviderStatus(
                                        index: index,
                                        value: e.isSelected ? false : true));
                              },
                              child: Container(
                                padding: EdgeInsets.symmetric(
                                ...
                                child: Text(
                                  ...
                                  style: GoogleFonts.nunitoSans(
                                    color: e.isSelected
                                        ? Colors.white
                                        : colorDropdownGrey.withOpacity(0.7),
                                    fontSize: 11.sp,
                                    fontWeight: FontWeight.w600,
                                  ),
                                ),
  ...
  Future<void> _displayDateDialog(
      ProvidersState state, BoxConstraints constrains) async {
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return Dialog(
            child: SizedBox(
              width:
                  constrains.maxWidth > 600 ? Adaptive.sp(60) : Adaptive.sp(70),
              child: BlocProvider.value(
                value: providersBloc,
                child: Material(
                  color: Colors.transparent,
