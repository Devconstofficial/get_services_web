...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<SideBarBloc, SideBarState>(builder: (context, state) {
          ...
          children: [
            ...
            Expanded(
              child: Scaffold(
                ...
                drawer: constraint.maxWidth >= 978
                    ? null
                    : SizedBox(
                ...
                appBar: AppBar(
                            ...
                            child: MouseRegion(
                              ...
                              child: Center(
                                child:
                                      ...
                                      Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.asset(state
                                              .languageImages[state.languages
                                                  .indexOf(state.languages
                                                      .firstWhere((e) =>
                                                          e.isSelected)) -
                                              1]),
                                        ),
                                  ...
                                  menuItemStyleData:
                                      menuItemStyleData(state.languages),
                                    ...
                                    if (selectedLanguage != null) {
                                      ...
                                      switch (selectedLanguage.name) {
                                        case "Arabic":
                                          ...
                                          break;
                                        case "Hebrew":
                                          context.setLocale(Locale("he", "IL"));
                                          break;
                                        case "English":
                                        default:
                  ...
                  bottom: PreferredSize(
                    preferredSize: const Size.fromHeight(
                        1.0), // Height of the bottom border
                    child: Container(
