...
class _PaymentFormState extends State<PaymentForm> {
  ...
  void initState() {
    ...
    paymentsBloc = context.read<PaymentBloc>();
  }
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if(state.customStartDate != null || state.paymentStatus.where((e) => e.isSelected).isNotEmpty)...[
                          Container(
                              width: 0.6,
                              color: lightGrayColor,
                              height:Adaptive.sp(24)
                          ...
                          InkWell(
                            onTap: (){
                              paymentsBloc.add(const PaymentEvent.resetFilter());
                            },
                            child: Padding(
                              padding:  EdgeInsets.only(left: Adaptive.sp(12),right: Adaptive.sp(10)),
                              child: Row(
                  ...
                  SizedBox(height: Adaptive.sp(14)),
                  Expanded(child: _buildPaymentTable(state.paymentData,state)),
                ],
              ),
            );
          },
  ...
  Widget _buildPaymentTable(List<Payment> requests,PaymentState state) {
    return  Container(
          ...
          Expanded(
            child: Theme(
              ...
              child: PaginatedDataTable2(
                ...
                onPageChanged: (index){
                  print(index);
                  context.read<PaymentBloc>().add(PaymentEvent.changeCurrentTablePageIndex(index: index));
                },
                ...
                source: PaymentDataSource(requests),
                rowsPerPage: 5,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            runSpacing: 8,
                            spacing: 8,
                            children: state.paymentStatus.map((e){
                              int index = state.paymentStatus.indexOf(e);
                              return InkWell(
                                onTap: (){
                                  context.read<PaymentBloc>().add(PaymentEvent.setPaymentStatus(index: index, value: e.isSelected?false:true));
                                },
                                child: Container(
  ...
  Future<void> _displayDateDialog(PaymentState state,BoxConstraints constrains) async {
    return showDialog(
        context: context,
        builder: (BuildContext context) {
          return Dialog(
                                  ...
                                  Padding(
                                    ...
                                    child: TableCalendar(
                                      ...
                                      onDaySelected: (date, events) {
                                        paymentsBloc.add(PaymentEvent.changeFilterDate(startDate: date, endDate: date));
                                      },
...
class PaymentDataSource extends DataTableSource {
  final List<Payment> providerRequests;

  PaymentDataSource(this.providerRequests);

  @override
  DataRow getRow(int index) {
    final request = providerRequests[index];
    return DataRow(cells: [
      DataCell(Center(child: Text(request.paymentId,style: GoogleFonts.nunitoSans(fontWeight: FontWeight.w500,color: appBlackColor.withOpacity(0.9),fontSize: 11.sp)))),
      DataCell(Center(child: Text(request.client,style: GoogleFonts.nunitoSans(fontWeight: FontWeight.w500,color: appBlackColor.withOpacity(0.9),fontSize: 11.sp)))),
